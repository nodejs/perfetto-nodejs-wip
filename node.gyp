  ...
  'targets': [
    ...
    }, # node_core_target_name
    {
      ...
      'sources': [
        ...
        'src/tracing/base/node_consumer_endpoint.cc',
        'src/tracing/base/node_producer_endpoint.cc',
        'src/tracing/base/node_task_runner.cc',
        'src/tracing/base/node_tracing.cc',
        'src/tracing/file_writer_consumer.cc',
        'src/tracing/tracing_controller_producer.cc',
        ...
        'src/tracing/base/node_consumer_endpoint.h',
        'src/tracing/base/node_producer_endpoint.h',
        'src/tracing/base/node_shared_memory.h',
        'src/tracing/base/node_task_runner.h',
        'src/tracing/base/node_tracing.h',
        'src/tracing/file_writer_consumer.h',
        'src/tracing/tracing_controller_producer.h',
